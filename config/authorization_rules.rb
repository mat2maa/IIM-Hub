authorization do
  ...
  role :video_programmer do
    ...
    has_permission_on :movies,
                      :to => [:manage,
                              :check_airline_rights,
    ...
    has_permission_on :movie_playlist_types,
                      :to => :manage
    has_permission_on :movie_playlist_items,
                      :to => :manage
    has_permission_on :video_playlist_items,
                      :to => :manage
    has_permission_on :video_master_playlist_items,
                      :to => :manage
    has_permission_on :screener_playlist_items,
                      :to => :manage
  ...
  role :programmer do
    has_permission_on :dashboard,
                      :to => :manage
    has_permission_on :vos,
                      :to => :manage
    has_permission_on :settings,
                      :to => :manage
    has_permission_on :airlines,
                      :to => :manage
    has_permission_on :albums,
                      :to => [:manage,
                              :amazon_cd_covers,
                              :show_genre,
                              :show_synopsis,
                              :show_tracks,
                              :show_playlists,
                              :show_tracks_translation,
                              :sort,
                              :restore,
                              :add_track,
                              :set_album_synopsis,
                              :download_album,
                              :poll_album_download_data,
                              :create_from_json]
    ...
    has_permission_on :album_playlist_items,
                      :to => :manage
    has_permission_on :audio_playlist_tracks,
                      :to => :manage
    has_permission_on :audio_playlists,
                      :to => [:manage,
                              :add_track,
                              ...
                              :duplicate,
                              :edit_audio_playlist_mastering,
                              :export,
                              :export_to_excel,
                              :find_track,
                              :set_audio_playlist_track_mastering,
                              :print,
                              :sort,
                              :splits,
                              :set_audio_playlist_track_split,
                              :set_audio_playlist_track_vo_duration,
                              :download_audio_playlist,
                              :poll_audio_playlist_download_data,
    ...
    has_permission_on :album_playlists,
                      :to => [:manage,
                              ...
                              :edit_synopsis,
                              :export_to_excel,
                              :export_albums_programmed_per_airline_to_excel,
                              :duplicate,
                              :set_album_playlist_item_category_id,
                              :set_audio_playlist_track_split,
                              :download_album_playlist,
                              :poll_album_playlist_download_data,
                              :export_by_airline,
                              :set_album_synopsis,
                              :add_multiple_albums,
                              :table_column_select]
  ...
  role :administrator do
    has_permission_on :dashboard,
                      :to => :manage
    has_permission_on :splits,
                      :to => :manage
    has_permission_on :vo_durations,
                      :to => :manage
    has_permission_on :vos,
                      :to => :manage
    has_permission_on :settings,
    ...
    has_permission_on :airline_rights_countries,
                      :to => :manage
    has_permission_on :movie_genres,
                      :to => :manage
    has_permission_on :movie_types,
                      :to => :manage
    has_permission_on :movie_playlist_types,
                      :to => :manage
    has_permission_on :video_genres,
                      :to => :manage
    has_permission_on :video_parent_genres,
                      :to => :manage
    has_permission_on :movies_settings,
                      :to => :manage
    has_permission_on :commercial_run_times,
                      :to => :manage
    has_permission_on :video_playlist_types,
                      :to => :manage
    has_permission_on :master_playlist_types,
                      :to => :manage
    has_permission_on :master_languages,
                      :to => :manage
    ...
    has_permission_on :users,
                      :to => [:manage,
                              ...
                              :enable,
                              :disable]
    has_permission_on :rights,
                      :to => :manage
    has_permission_on :roles,
                      :to => :manage
    has_permission_on :import_album,
                      :to => [:read,
                              :find_release,
