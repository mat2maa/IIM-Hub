...
prawn_document page_size: 'A4' do |pdf|
  ...
  table_data << ['Has Press Kit?', @movie.has_press_kit.present? ? @movie.has_press_kit.to_s : '']
  ...
  table_data << ['Release Versions', @movie.release_versions.present? ? @movie.release_versions.join(', ') : '']
  ...
  table_data << ['Screener Remarks', @movie.screener_remarks.present? ? @movie.screener_remarks.join(', ') : '']
